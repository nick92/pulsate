...
public class SDLSample : Object {
    ...
    private const int SCREEN_WIDTH = 840;
    ...
    private void draw () {
        ...
        Rectangle.fill_color (this.screen, 0, 0, 100, y, color);
        Rectangle.outline_color (this.screen, 0, 0, 100, y, color);
        Pixel.color(this.screen, x, y, color);
